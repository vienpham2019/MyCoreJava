...
//		testAnimalEquality(); 
	...
	private void testAnimalEquality() {
		...
		Lion smallFLion = new Lion(5, 220 , Sex.FEMALE);
		Lion oldFLion = new Lion(12, 300 , Sex.FEMALE);
	...
	/*
	 *  The hashCode method implementation should follow the hashCode contract:
	 *  
	 ...
	 *		However, creating as many bins as possible could significantly improve the performance of hashed collections. 
	 */
	...
	private void testAnimalHashCode() {
		...
		System.out.println("Dog a hashCode: " + a.hashCode());
		System.out.println("Dog b hashCode: " + b.hashCode());
		System.out.println("Dog c hashCode: " + c.hashCode());
		System.out.println("Dog d hashCode: " + d.hashCode());
